...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ahocorasick_match,
0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ahocorasick_deinit,
0, 0, 1)
ZEND_ARG_INFO(0, id)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ahocorasick_add_patterns,
0, 0, 2)
ZEND_ARG_INFO(0, id)
