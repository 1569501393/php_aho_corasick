...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_ahocorasick_match,
0, 2, MAY_BE_FALSE|MAY_BE_ARRAY)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ahocorasick_init,
0, 0, 1)
ZEND_ARG_TYPE_INFO(0, data, IS_ARRAY, 0)

ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ahocorasick_deinit,
0, 1, _IS_BOOL, 0)
ZEND_ARG_INFO(0, id)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_ahocorasick_add_patterns,
0, 2, _IS_BOOL, 0)
ZEND_ARG_INFO(0, id)
